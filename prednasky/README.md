...
| 4.      | Data gathering and data integration                         | Získavanie a prepájanie údajov                              |
| 5.      | Exploratory Data Analysis using statistical analysis        | Prieskumná analýza s využitím štatistickej analýzy          |
| 6.      | Data cleaning and data preprocessing                        | Čistenie a predspracovanie údajov                           |
| 7.      | Preprocessing of textual data                               | Predspracovanie textových dát                               |
| 8.      | Performance evaluation and model selection                  | Vyhodnocovanie a výber modelov                              |
| 9.      | Linear and logistic regression                              | Lineárna a logistická regresia                              |
| 10.     | Decision trees                                              | Rozhodovacie stromy                                         |
